...
#import "UIBarButtonItem+WCYBadge.h"
...
@implementation UIBarButtonItem (WCYBadge)
...
- (void)removeBadge {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        // 有疑问 在考虑 在UIbutton中没问题 在此加上会出警告 Null passed to a callee that requires a non-null argument
//        self.badge = nil;
    }];
}
