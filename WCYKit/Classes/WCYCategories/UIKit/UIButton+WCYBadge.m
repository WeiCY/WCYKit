...
@implementation UIButton (WCYBadge)
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    NSLog(@"%d   %d   %d   %d",!badgeValue,[badgeValue isEqualToString:@""],[badgeValue isEqualToString:@"0"],self.shouldHideBadgeAtZero);
